...
class TestRallpack3(unittest.TestCase):
    def test_rallpack3(self):
        ...
        for t in memb_tris: sim.setTriSpecCount(t, 'Leak', 1)

        sim.setPatchSpecCount('memb', 'Na_m0h1', (Na_ro*surfarea_cyl*NA_FACS[0]))
        sim.setPatchSpecCount('memb', 'Na_m1h1', (Na_ro*surfarea_cyl*NA_FACS[1]))
        sim.setPatchSpecCount('memb', 'Na_m2h1', (Na_ro*surfarea_cyl*NA_FACS[2]))
        sim.setPatchSpecCount('memb', 'Na_m3h1', (Na_ro*surfarea_cyl*NA_FACS[3]))
        sim.setPatchSpecCount('memb', 'Na_m0h0', (Na_ro*surfarea_cyl*NA_FACS[4]))
        sim.setPatchSpecCount('memb', 'Na_m1h0', (Na_ro*surfarea_cyl*NA_FACS[5]))
        sim.setPatchSpecCount('memb', 'Na_m2h0', (Na_ro*surfarea_cyl*NA_FACS[6]))
        sim.setPatchSpecCount('memb', 'Na_m3h0', (Na_ro*surfarea_cyl*NA_FACS[7]))
        sim.setPatchSpecCount('memb', 'K_n0', (K_ro*surfarea_cyl*K_FACS[0]))
        sim.setPatchSpecCount('memb', 'K_n1', (K_ro*surfarea_cyl*K_FACS[1]))
        sim.setPatchSpecCount('memb', 'K_n2', (K_ro*surfarea_cyl*K_FACS[2]))
        sim.setPatchSpecCount('memb', 'K_n3', (K_ro*surfarea_cyl*K_FACS[3]))
        sim.setPatchSpecCount('memb', 'K_n4', (K_ro*surfarea_cyl*K_FACS[4]))
