...
Iain Hepburn, Jules Lallouette, Weiliang Chen, Andrew R. Gallimore, Sarah Y. Nagasawa-Soeda, Erik De Schutter: Vesicle and reaction-diffusion hybrid modeling with STEPS. Communications Biology 7, 573 (2024). https://doi.org/10.1038/s42003-024-06276-5
...
**parallel_kissandrun.py**
 ...
 - data is recorded to data/kissandrun.h5
...
**parallel_endocytosis.py**
 - runtime ~1 minute on 2 cores 
 - produces plot plots/endocytosis_spec.pdf, plots/endocytosis_ves.pdf shown in Fig. 4c, d
...
**parallel_vesreac_comp2.py**
 - extends the vesreac test with 2 compartments. Diffusion is permitted between compartments.
 - runtime ~10 minutes on 4 cores
 - produces plot plots/vesreac_comp2.pdf
 - data is recorded to data/vesreac_comp2.h5
...
**parallel_raftsreac_weight.py**
 - extends the raftsreac test with weighted partitioning
 - runtime ~10 minutes on 8 cores
 - produces plot plots/raftsreac_weight.pdf
 - data is recorded to data/raftsreac_weight.h5
