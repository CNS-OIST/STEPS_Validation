...
class VesicleVesReacComp2(unittest.TestCase):
    def test_vesreac_comp2_n8(self):
        ...
        partition = TetWeightPartition(mesh, prefix="weights/vsr_comp2", n_hosts=8, start_host=1, method='extents')
        ...
        if MPI.rank == 0:
            with HDF5Handler(filePrefix) as hdf:
                rs_foi, rs_for, rs_soAA, rs_soAB = hdf['vesreac_comp2'].results
                tpnts = rs_for.time[0]
